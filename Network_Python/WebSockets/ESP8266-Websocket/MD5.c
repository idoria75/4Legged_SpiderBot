...
void MD5InitX (MD5_CTX *context)                                       /* context */
{
 ...
 * context.
 */
void MD5UpdateX (MD5_CTX *context, unsigned char *input,unsigned int inputLen) /* length of input block */
{
 ...
 */
void MD5FinalX (unsigned char digest[16], MD5_CTX *context)
{
  ...
  MD5UpdateX (context, PADDING, padLen);

  /* Append length (before padding) */
  MD5UpdateX (context, bits, 8);
...
void MD5(unsigned char strInputString[], unsigned char md5Digest[], unsigned int len){
	...
	MD5UpdateX(&ctx, strInputString, len);
	MD5FinalX(md5Digest, &ctx);
}