...
<a href="https://github.com/reach/router"><img src="./internals/img/reach-router-padded-90.png" /></a>
<a href="https://github.com/styled-components/styled-components"><img src="./internals/img/styled-components-padded-90.png" /></a>
...
For an example app that uses the same boilerplate on which this project was based and packages native dependencies, see [erb-sqlite-example](https://github.com/amilajack/erb-sqlite-example).
...
If you want to use Sass, you only need to import `.sass` files instead of `.css` once:
...
This project was adapted from [electron-react-boilerplate](https://github.com/chentsulin/electron-react-boilerplate). 
